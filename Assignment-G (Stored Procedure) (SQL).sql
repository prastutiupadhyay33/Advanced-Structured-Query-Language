...
#1 Create a procedure to show all employees details.
...
#3 Create a stored procedure to increase salary by a given percentage for a department.
...
#4 Create a procedure to return the total salary of all employees.
...
#5 Create a procedure to insert a new employee into an existing table.
...
#6 Create a procedure to delete an existing employee from the table by id.
...
#7 Create a procedure to return average salary.
...
#8 Create a procedure to get employees above a salary.
...
#9 Create a procedure to get highest salary.
...
#10 Create a procedure to update employee name.
